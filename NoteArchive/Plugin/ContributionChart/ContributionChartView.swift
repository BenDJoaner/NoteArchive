...
public struct ContributionChartView: View {
    ...
    var heatMapRectangleWidth: Double = 10.0
    var heatMapRectangleSpacing: Double = 2.0
    var heatMapRectangleRadius: Double = 5.0
    
    public init(data: [Double], rows: Int, columns: Int, targetValue: Double, blockColor: Color = Color.green, blockBackgroundColor: Color, RectangleWidth: Double = 10.0, RectangleSpacing: Double = 2.0, RectangleRadius: Double = 5.0){
        self.data = data
        self.rows = rows
